...
import com.ochwada.secure_joke_vault.security.JWTFilter;
import lombok.*;
 ...
 * Author: Ochwada
 * Date: Thursday, 24.Jul.2025, 9:41 AM
...
public class SecurityConfig {
     ...
     */
    @Bean // The result is stored in the Spring container and injected when needed
     ...
     * credentials during login). This method retrieves
     * the pre-configured authentication manager from the provided {@link AuthenticationConfiguration}.
     * <p>
     * Spring automatically sets up this manager based on the configured {AuthenticationProvider}s
     * (e.g., DAO-based authentication with a UserDetailsService).
     *
